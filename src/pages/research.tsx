...
const metaData = {
  url: 'https://naoya-takeda.netlify.app/research',
  title: 'Research - Naoya Takeda',
  description:
    'Research activities of Naoya Takeda, focusing on agricultural and environmental sciences. ',
};
        ...
        >
          <div css={inner}>
            <SiteHeaderContent className="site-header-conent">
              <SiteTitle className="site-title">RESEARCH</SiteTitle>
              <SiteDescription>Agricultural & Environmental Sciences</SiteDescription>
            </SiteHeaderContent>
          </div>
        </div>
